...
<body>
    ...
    <header style="height: 80px; text-align: center; ">
        <nav>
            ...
            <a style="padding-right: 15px; font-size: 20px;" href="index.php?action=readall&controller=utilisateur">Compte</a>
            <a style="padding-right: 15px; font-size: 20px;" href="index.php?action=readall&controller=trajet">Liste Trajets</a>
        </nav>
    </header>
